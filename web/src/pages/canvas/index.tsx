            ...
            <div className="canvas-library-frame">
                {selectedIds.length ? (
                    <div className="app-canvas-selection-toolbar mt-2 flex min-h-10 flex-wrap items-center gap-2 rounded-md border px-3 py-1.5 text-xs">
                        ...
                        <Button size="small" disabled={!hydrated} icon={<Download className="size-3.5" />} onClick={() => void exportCanvasProjects(selectedProjects, `S1API-Studio-画布-${selectedIds.length}个画布`)}>
                            导出
                        </Button>
