...
ARG VITE_CANVAS_AUTH_MODE
ARG VITE_CANVAS_GENERATED_MEDIA_MODE
ENV VITE_TLDRAW_LICENSE_KEY=${VITE_TLDRAW_LICENSE_KEY}
ENV VITE_CANVAS_AUTH_MODE=${VITE_CANVAS_AUTH_MODE}
ENV VITE_CANVAS_GENERATED_MEDIA_MODE=${VITE_CANVAS_GENERATED_MEDIA_MODE}
